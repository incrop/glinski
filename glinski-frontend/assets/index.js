...
define("draw", ["require", "exports", "shapes"], function (require, exports, shapes_1) {
        ...
        field.forEach((file, fileIdx) => {
            ...
            file.forEach((cell, rankIdx) => {
                ...
                if (cell.piece) {
                    ...
                    ctx.scale(shapes_1.shapeScale * m, -shapes_1.shapeScale * m);
    ...
    const drawPiece = (ctx, color, piece) => {
        const fillStyles = ['#000', '#fff'];
        let fillStyleIdx = 0;
        shapes_1.shapes[color][piece].forEach((path) => {
...
define("temp", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.generateFiled = void 0;
    const generateFiled = () => {
        const field = Array.from(Array(11), (_, fileIdx) => Array.from(Array(11 - Math.abs(5 - fileIdx)), (_, rankIdx) => ({
            fileIdx,
            rankIdx,
            color: ['dark', 'mid', 'light'][(fileIdx + rankIdx + Math.max(0, fileIdx - 5)) % 3],
            piece: undefined,
        })));
    ...
    exports.generateFiled = generateFiled;
});
define("index", ["require", "exports", "draw", "temp"], function (require, exports, draw_1, temp_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const canvas = document.getElementsByTagName('canvas')[0];
    const ctx = canvas.getContext('2d');
    ctx.translate(0.5, 0.5);
    const field = (0, temp_1.generateFiled)();
    const onResize = () => {
        const width = Math.min(window.innerHeight, window.innerWidth);
        canvas.height = width;
        canvas.width = width;
        (0, draw_1.drawField)(ctx, field);
    };
